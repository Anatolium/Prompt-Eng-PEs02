...
@observe
def conversation_cot_simple_max(user_input):
    ...
    llm = ChatOpenAI(
        ...
        temperature=0.2,  # параметр креативности (низкое значение — более детерминированный текст)
        max_tokens=500,  # максимальное число токенов в ответе модели (ограничивает длину ответа)
...
if __name__ == "__main__":
    try:
        text = conversation_cot_simple_max('Наушники с шумоподавлением и микрофоном для тренировок')
