# Добавим контекст и блок рассуждений в промпт
import os
import logging
import time
...
@observe
def conversation_cot(user_input):
...
if __name__ == "__main__":
    try:
        text = conversation_cot('Наушники с шумоподавлением и микрофоном для тренировок')
